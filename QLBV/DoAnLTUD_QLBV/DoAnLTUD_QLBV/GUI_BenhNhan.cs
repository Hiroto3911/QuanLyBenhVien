    ...
    public partial class GUI_BenhNhan : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_BenhNhan.Phai = cb_phai.Text;
                et_BenhNhan.Bhyt = txt_bhyt.Text;
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn xoá {et_BenhNhan.Ma}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn sửa {et_BenhNhan.Ma}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (rs == DialogResult.Cancel) return;
        ...
        private void dgv_BenhNhan_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cb_phai.Text = dgv_BenhNhan.Rows[dong].Cells[6].Value.ToString();
                txt_bhyt.Text = dgv_BenhNhan.Rows[dong].Cells[7].Value.ToString();
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Lỗi : {ex}", "Thông báo Lỗi");
        ...
        private void dgv_BenhNhan_DoubleClick(object sender, EventArgs e)
        {
            //dgv_BenhNhan.DataSource = 
        }
    }
}
