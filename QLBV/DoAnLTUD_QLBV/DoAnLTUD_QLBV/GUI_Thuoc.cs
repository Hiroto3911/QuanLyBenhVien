...
namespace GUI_QLBV
{
    public partial class GUI_Thuoc : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            try
            {
                et_Thuoc.MaThuoc = txt_ID.Text;
                et_Thuoc.Gia = Convert.ToDouble(txt_Gia.Text);
                et_Thuoc.TenThuoc = txt_Ten.Text;
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_Thuoc.Gia = Convert.ToDouble(txt_Gia.Text);
                et_Thuoc.TenThuoc = txt_Ten.Text;
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn xoá {et_Thuoc.MaThuoc}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_Thuoc.Gia = Convert.ToDouble(txt_Gia.Text);
                et_Thuoc.TenThuoc = txt_Ten.Text;
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn sửa {et_Thuoc.MaThuoc}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (rs == DialogResult.Cancel) return;
        ...
        private void dgv_Thuoc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txt_Gia.Text = dgv_Thuoc.Rows[dong].Cells[2].Value.ToString();
