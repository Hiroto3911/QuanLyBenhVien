...
namespace GUI_QLBV
{
    public partial class GUI_BenhAn : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            try
            {
                et_BenhAn.MaBenhAn = txt_ID.Text;
                et_BenhAn.MaBenhNhan = txt_BenhNhanID.Text;
                et_BenhAn.KetQua = txt_KetQua.Text;
                et_BenhAn.NgayNhapVien = dtpNhap.Value;
                et_BenhAn.NgayXuatVien = dtpXuat.Value;
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_BenhAn.NgayNhapVien = dtpNhap.Value;
                et_BenhAn.NgayXuatVien = dtpXuat.Value;
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn xoá {et_BenhAn.MaBenhAn}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_BenhAn.MaBenhNhan = txt_BenhNhanID.Text;
                et_BenhAn.KetQua = txt_KetQua.Text;
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn sửa {et_BenhAn.MaBenhAn}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (rs == DialogResult.Cancel) return;
        ...
        private void dgv_BenhNhan_Click(object sender, EventArgs e)
        {
            ...
            dtpNhap.Text =dgv_BenhAn.Rows[dong].Cells[2].Value.ToString();
            dtpXuat.Text = dgv_BenhAn.Rows[dong].Cells[3].Value.ToString()== null?DateTime.Now.ToString():dgv_BenhAn.Rows[dong].Cells[3].Value.ToString();
            txt_KetQua.Text = dgv_BenhAn.Rows[dong].Cells[4].Value.ToString();
        }
