...
namespace GUI_QLBV
{
    public partial class GUI_DichVu : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            try
            {
                et_DichVu.MaDichVu = txt_ID.Text;
                et_DichVu.TenDichVu = txt_TenDV.Text;
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_DichVu.TenDichVu = txt_TenDV.Text;
                et_DichVu.Gia = Convert.ToDouble(txt_Gia.Text);
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn xoá {et_DichVu.MaDichVu}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                et_DichVu.TenDichVu = txt_TenDV.Text;
                et_DichVu.Gia = Convert.ToDouble(txt_Gia.Text);
                DialogResult rs = MessageBox.Show($"Bạn có chắc muốn sửa {et_DichVu.MaDichVu}", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (rs == DialogResult.Cancel) return;
