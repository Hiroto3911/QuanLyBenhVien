...
AS
 SELECT  BENHNHAN.MABN, BENHNHAN.HOBN, BENHNHAN.TENBN ,CONCAT(BENHNHAN.HOBN,' ', BENHNHAN.TENBN) AS N'HỌ VÀ TÊN', BENHNHAN.SODTH, BENHNHAN.DIACHI, BENHNHAN.PHAI, BENHNHAN.MABHYT AS N'BẢO HIỂM Y TẾ' ,BENHAN.MABA AS N'BỆNH ÁN',BENHAN.KETQUA AS N'KẾT QUẢ BỆNH ÁN' 
